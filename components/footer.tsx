...
const socialLinks = [
    {
        href: "https://www.facebook.com/LebaneseYouthFoundation/",
        label: "Facebook",
    ...
    {
        href: "https://www.instagram.com/lebaneseyouthfoundation/",
        label: "Instagram",
        icon: <svg width="24" height="24" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        href: "https://www.youtube.com/channel/UCVz_yBeGo9KddC0flYu-B4A",
        label: "YouTube",
        icon: <svg width="24" height="24" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
        href: "https://chat.whatsapp.com/D98gi493pZdBsBVi8rXP2L",
        label: "WhatsApp",
        icon: <svg width="24" height="24" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="space-y-6 md:space-y-0 flex flex-col md:flex-row md:items-start items-center md:justify-around justify-start gap-4">
                    ...
                    <div className="items-center md:items-start flex flex-col">
                        <h3 className="text-lg font-bold pb-3">Connect with us</h3>
                            ...
                            {socialLinks.map((link) => {
                                ...
                                return (
                                    <a
                                        ...
                                        className="text-gray-600 hover:text-gray-900 transition-colors flex gap-2"
                                    >
                                        {Icon}
                    ...
                    {/* Contact Info */}
                    <div className="items-center md:items-start flex flex-col">
                        <h3 className="text-lg font-bold pb-3">Contact us</h3>
                ...
                {/* Copyright */}
                <div className="mt-8 pt-8 border-t text-center text-gray-600 w-full">
                    <p>© {new Date().getFullYear()} LYF. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
